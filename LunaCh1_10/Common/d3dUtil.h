...
namespace Colors
{
	...
	XMGLOBALCONST XMVECTORF32 Green     = {0.0f, 1.0f, 0.0f, .5f};
	XMGLOBALCONST XMVECTORF32 Blue      = {0.0f, 0.0f, 1.0f, 1.0f};
	XMGLOBALCONST XMVECTORF32 Yellow    = {1.0f, 1.0f, 0.0f, .5f};
	XMGLOBALCONST XMVECTORF32 Cyan      = {0.0f, 1.0f, 1.0f, 1.0f};
	XMGLOBALCONST XMVECTORF32 Magenta   = {1.0f, 0.0f, 1.0f, 1.0f};
	XMGLOBALCONST XMVECTORF32 RedHalf = { 1.0f, 0.0f, 0.0f, 0.5f };
	XMGLOBALCONST XMVECTORF32 BlueHalf = { 0.0f, 0.0f, 1.0f, 0.5f };
