...
//edit:
ID3D11BlendState*      RenderStates::AlphaBlending = 0;
ID3D11BlendState*      RenderStates::AdditiveBlending = 0;
ID3D11BlendState*      RenderStates::MultiplicativeBlending = 0;
ID3D11BlendState*      RenderStates::MultiplicativeBlendingX2 = 0;
...
void RenderStates::DestroyAll()
{
	...
	ReleaseCOM(AlphaBlending);
	ReleaseCOM(AdditiveBlending);
	ReleaseCOM(MultiplicativeBlending);
	ReleaseCOM(MultiplicativeBlendingX2);
...
ID3D11BlendState*      RenderStates::TransparentBSMulti = 0;
ID3D11BlendState*      RenderStates::TransparentBSAdditive = 0;
...
void RenderStates::InitAll(ID3D11Device* device)
{
	...
	transparentMultiDesc.AlphaToCoverageEnable = false;
	transparentMultiDesc.IndependentBlendEnable = false;

	transparentMultiDesc.RenderTarget[0].BlendEnable = true;
	transparentMultiDesc.RenderTarget[0].SrcBlend = D3D11_BLEND_ZERO;
	transparentMultiDesc.RenderTarget[0].DestBlend = D3D11_BLEND_SRC_COLOR;
	transparentMultiDesc.RenderTarget[0].BlendOp = D3D11_BLEND_OP_ADD;
	transparentMultiDesc.RenderTarget[0].SrcBlendAlpha = D3D11_BLEND_ONE;
	transparentMultiDesc.RenderTarget[0].DestBlendAlpha = D3D11_BLEND_ZERO;
	transparentMultiDesc.RenderTarget[0].BlendOpAlpha = D3D11_BLEND_OP_ADD;
	transparentMultiDesc.RenderTarget[0].RenderTargetWriteMask = D3D11_COLOR_WRITE_ENABLE_ALL;

	HR(device->CreateBlendState(&transparentMultiDesc, &TransparentBSMulti));

	//
	// TransparentBSAditive
	// Additive blending

	D3D11_BLEND_DESC transparentAddtiveDesc = { 0 };
	transparentAddtiveDesc.AlphaToCoverageEnable = false;
	transparentAddtiveDesc.IndependentBlendEnable = false;

	transparentAddtiveDesc.RenderTarget[0].BlendEnable = true;
	transparentAddtiveDesc.RenderTarget[0].SrcBlend = D3D11_BLEND_ONE;
	transparentAddtiveDesc.RenderTarget[0].DestBlend = D3D11_BLEND_ONE;
	transparentAddtiveDesc.RenderTarget[0].BlendOp = D3D11_BLEND_OP_ADD;
	transparentAddtiveDesc.RenderTarget[0].SrcBlendAlpha = D3D11_BLEND_ONE;
	transparentAddtiveDesc.RenderTarget[0].DestBlendAlpha = D3D11_BLEND_ZERO;
	transparentAddtiveDesc.RenderTarget[0].BlendOpAlpha = D3D11_BLEND_OP_ADD;
	transparentAddtiveDesc.RenderTarget[0].RenderTargetWriteMask = D3D11_COLOR_WRITE_ENABLE_ALL;

	HR(device->CreateBlendState(&transparentAddtiveDesc, &TransparentBSAdditive));
