...
void BoxApp::DrawScene()
{
	...
	for (UINT p = 0; p < techDesc.Passes; ++p)
	{
		...
		md3dImmediateContext->OMSetBlendState(RenderStates::TransparentBSMulti, blendFactor, 0xffffffff);
	...
	for (UINT p = 0; p < techDesc.Passes; ++p)
	{
		...
		md3dImmediateContext->OMSetBlendState(RenderStates::TransparentBSAdditive, blendFactor, 0xffffffff);
